...
urlpatterns = [
    ...
    url(r'^demand/demand_(?P<id>[0-9]+).xls', views.convert_demand,
    ...
    url(r'^purchase-order/purchase_order_(?P<id>[0-9]+).xls', views.convert_purchase_order,
        name='convert_purchase_order'),

    url(r'^purchase-orders/$', views.list_purchase_orders, name='list_purchase_orders'),
    url(r'^entry-report/entry_report_(?P<id>[0-9]+).xls', views.convert_entry_report,
    ...
    url(r'^demand/demand_(?P<pk>\d+).pdf', views.DemandPDF.as_view(), name='demand_form_as_pdf'),
    url(r'^purchase/purchase_(?P<pk>\d+).pdf', views.PurchaseOrderPDF.as_view(), name='purchase_order_as_pdf'),
    url(r'^entry_report/entry_report_(?P<pk>\d+).pdf', views.EntryReportPDF.as_view(), name='entry_report_as_pdf'),
    url(r'^handover/handover_(?P<pk>\d+).pdf/', views.HandoverPDF.as_view(), name='handover_as_pdf'),
    url(r'^inspection/inspection_(?P<pk>\d+).pdf', views.InspectionPDF.as_view(), name='inspection_as_pdf'),
    url(r'^yearly_report/yearly_report_(?P<pk>\d+).pdf', views.YearlyReportPDF.as_view(), name='yearly_report_as_pdf'),
    url(r'^quotation_comparison/quotation_comparison_(?P<pk>\d+).pdf', views.QuotationComparisonPDF.as_view(),
        name='quotation_comparison_as_pdf'),

    url(r'^stock_entryies/$', views.StockEntryList.as_view(), name='list_stock_entry'),
    ...
    url(r'^stock_entry/(?P<id>[0-9]+)/delete$', views.delete_stock_entry,
